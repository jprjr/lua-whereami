...
all: whereami.so whereami.a

whereami.a: whereami/src/whereami.o lua-whereami.o
	$(AR) rcs whereami.a lua-whereami.o whereami/src/whereami.o
	$(RANLIB) whereami.a

whereami.so: whereami/src/whereami.o lua-whereami.o
	$(CC) -shared $(LUA_LIBS) -o whereami.so lua-whereami.o whereami/src/whereami.o
...
clean:
	rm -f whereami/src/whereami.o lua-whereami.o whereami.so whereami.a
